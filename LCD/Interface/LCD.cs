    ...
    public partial class LCD : Form
    {
        ...
        private void AddGatesAnd()
        {
            if (tabControl.SelectedTab != null)
                (tabControl.SelectedTab.Controls[0] as CircuitView).AddGate(new And(tsNrInputs.SelectedIndex+2, new Point(10, 10)));
        }

        private void AddGatesOr()
        {
            if (tabControl.SelectedTab != null)
                (tabControl.SelectedTab.Controls[0] as CircuitView).AddGate(new Or(tsNrInputs.SelectedIndex + 2, new Point(10, 10)));
        }

        private void AddGatesNot()
        {
            if (tabControl.SelectedTab != null)
                (tabControl.SelectedTab.Controls[0] as CircuitView).AddGate(new Not(new Point(10, 10)));
        }

        private void AddGatesXor()
        {
            if (tabControl.SelectedTab != null)
                (tabControl.SelectedTab.Controls[0] as CircuitView).AddGate(new Xor(tsNrInputs.SelectedIndex + 2, new Point(10, 10)));
        }

        private void AddGatesNand()
        {
            if (tabControl.SelectedTab != null)
                (tabControl.SelectedTab.Controls[0] as CircuitView).AddGate(new Nand(tsNrInputs.SelectedIndex + 2, new Point(10, 10)));
        }

        private void AddGatesNor()
        {
            if (tabControl.SelectedTab != null)
                (tabControl.SelectedTab.Controls[0] as CircuitView).AddGate(new Nor(tsNrInputs.SelectedIndex + 2, new Point(10, 10)));
        }
        private void AddGatesNxor()
        {
            if (tabControl.SelectedTab != null)
                (tabControl.SelectedTab.Controls[0] as CircuitView).AddGate(new Nxor(tsNrInputs.SelectedIndex + 2, new Point(10, 10)));
        }

        private void AddGatesBtn()
        {
            if (tabControl.SelectedTab != null)
                (tabControl.SelectedTab.Controls[0] as CircuitView).AddGate(new Btn(new Point(10, 10)));
        }

        private void AddGatesLed()
        {
            if (tabControl.SelectedTab != null)
                (tabControl.SelectedTab.Controls[0] as CircuitView).AddGate(new Led(new Point(10, 10)));
        }

        private void AddGatesClk()
        {
            if (tabControl.SelectedTab != null)
                (tabControl.SelectedTab.Controls[0] as CircuitView).AddGate(new Clk(new Point(10, 10)));
        }

        private void AddGatesInput()
        {
            if (tabControl.SelectedTab != null)
                (tabControl.SelectedTab.Controls[0] as CircuitView).AddGate(new Input(new Point(10, 10)));
        }

        private void AddGatesSSD()
        {
            if (tabControl.SelectedTab != null)
                (tabControl.SelectedTab.Controls[0] as CircuitView).AddGate(new SSD(new Point(10, 10)));
        }
        ...
        private void AddGatesMod()
        {
            if (tabControl.SelectedTab != null)
            {
                ...
                if (openDialog.ShowDialog() == DialogResult.OK)
                {
                    ...
                    {
                        (tabControl.SelectedTab.Controls[0] as CircuitView).AddGate(
                            new Module((String)openDialog.FileNames.GetValue(i), new Point(10, i*10)));
                    }
                }
        ...
        void cv_OnGateSelected(Gate gate)
        {
            propertyGrid.SelectedObject = gate;
        }
